...
<Quiz questions={[
  {
    question: "NVIDIA GPUにおける「アーキテクチャ」と「世代（Generation）」の違いとして正しいものはどれですか？",
    options: [
      "アーキテクチャは用途別カテゴリで，世代はチップの設計を指す",
      "アーキテクチャはGPUチップの設計・能力を指し，世代はGPUの用途別カテゴリを指す",
      "アーキテクチャと世代は同じ意味である",
      "世代はリリース年を指し，アーキテクチャはメーカー名を指す"
    ],
    answer: 1,
    explanation: "アーキテクチャはGPUチップの設計と能力（例：Hopper，Ampere，Volta）を指し，世代はGPUの用途別カテゴリ（例：GeForce，Tesla，Quadro）を指します．1つのアーキテクチャから複数の世代のGPUが製造されます．"
  },
  {
    question: "Tesla世代のGPUの主な用途は何ですか？",
    options: [
      "ゲーマー向けの3Dグラフィックス",
      "モバイルデバイス向けのSoC",
      "HPC（高性能計算）環境・スーパーコンピュータ",
      "プロフェッショナルワークステーション向け"
    ],
    answer: 2,
    explanation: "Tesla世代のGPUはHPC（高性能計算）環境向けに設計されており，スーパーコンピュータやクラウドサーバーで使用されます．A100，V100，P100などが代表例です．なお，Elon Muskの企業とは無関係です．"
  },
  {
    question: "Ampereアーキテクチャに基づくGPUとして正しい組み合わせはどれですか？",
    options: [
      "GeForce GTX 480とTesla X2070",
      "GeForce RTX 3090とTesla A100",
      "GeForce RTX 4090とTesla H100",
      "GeForce GTX 980 TiとTesla M60"
    ],
    answer: 1,
    explanation: "Ampereアーキテクチャ（2020年リリース）には，GeForce世代のRTX 3090（一般消費者向け）とTesla世代のA100（HPC向け）が含まれます．同じアーキテクチャから異なる市場向けのGPUが製造されています．"
  }
]} />
