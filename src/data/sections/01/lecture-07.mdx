...
<Quiz questions={[
  {
    question: "FermiからHopperまでのスループットはおよそ何倍に向上しましたか？",
    options: [
      "約10倍",
      "約50倍",
      "約100倍",
    ...
    answer: 3,
    explanation: "Fermiの1.2 TFLOPSからHopperの378 TFLOPSまで，約300倍以上のスループット向上が実現されました．"
  },
  {
    question: "Pascal以降のHPC向けGPUの命名パターンとして正しいものはどれですか？",
    options: [
      "アーキテクチャ名の全文字+GPU番号",
      "アーキテクチャの頭文字+100",
      "世代名+チップ番号",
    ...
    answer: 1,
    explanation: "Pascal以降，HPC向けGPUはアーキテクチャの頭文字+100という命名パターンを採用しています．Pascal: P100，Volta: V100，Ampere: A100，Hopper: H100という一貫したパターンです．"
  },
  {
    question: "HPC向けGPUのクロック速度が消費者向けGPUより低い傾向がある理由は何ですか？",
    options: [
      "HPC環境ではクロック速度が不要なため",
      "エネルギー消費を抑えるため",
      "製造コストを削減するため",
    ...
    answer: 1,
    explanation: "HPC向けGPUはクロック速度を抑える傾向がありますが，これはエネルギー消費と直接関係しています．スーパーコンピュータでは多数のGPUが搭載されるため，エネルギー効率が重要な設計要件となります．"
  }
]} />
